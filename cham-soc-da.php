...
<body>
    <header class="clear-fix">
        ...
        <nav class="nav-bar">
            <ul class="clear-fix">
                ...
                <li class="cur-tab"><a href="cham-soc-da.php">Chăm sóc da</a>
                </li>
    ...
    $sql = "SELECT name, price, image_link, id FROM t_product WHERE catalog_id=3 ORDER BY DISCOUNT desc LIMIT ".strval($page_range+1).",".strval($page_range+$max_item)."";
    $query = mysqli_query($conn, $sql);
